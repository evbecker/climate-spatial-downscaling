...
#for l1_lambda in [0.2]:
        for mode in ['ours']:
            ...
            network_d=Discriminator(size1=dataset,size2=dataset)
                ...
                with torch.no_grad():
                    ...
                    if total_loss<loss_max:
                        ...
                        if dataset==40:
                            ...
                            if mode=='ours':
                                torch.save(network_g.state_dict(),'_generator'+str(l1_lambda)+'.pt')
                            else:
                                torch.save(network_g.state_dict(),'_generator'+str(l1_lambda)+'_.pt')
